...
def open_encode_faces():
    ...
    process = subprocess.Popen(['python', 'encode.py'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout, stderr = process.communicate()
...
img = Image.open("C:/Mukul/Student Attendance/bg.jpg")
...
attendance_icon = PhotoImage(file="attendance.png")
encode_icon = PhotoImage(file="encode.png")
