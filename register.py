...
def capture_images(student_name, student_id, num_images=50, img_format='jpg'):
    directory = f"C:/Mukul/Student Attendance/data/student/{student_id}"
    ...
    haarcasecade_path = "C:/Mukul/Student Attendance/haarcascade_frontalface_default.xml"
...
def remove_existing_student(student_id):
    excel_file = "C:/Mukul/Student Attendance/data/registrations/students.xlsx"
...
def register_student_window():
    ...
    img = Image.open("C:/Mukul/Student Attendance/1.jpg")
